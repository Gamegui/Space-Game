 ...
 *  Экспортируется для тестов: общий запас живых осколков легитимно превышает
 *  его (осколки живут до вылета за экран), а цепной взрыв даёт тысячи. */
export const MAX_DISCHARGE_SHARDS_PER_FRAME = 40;
